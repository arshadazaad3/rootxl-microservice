...
import { User } from 'database/repositories/core';
...
export class AuthController {
  ...
  @Post('email/verify')
  @HttpCode(HttpStatus.NO_CONTENT)
  async verifyEmail(@Body() confirmEmailDto: AuthConfirmEmailDto): Promise<void> {
    return this.service.verifyEmail(confirmEmailDto.hash);
  }
